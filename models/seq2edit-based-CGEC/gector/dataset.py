...
from utils.helpers import INCORRECT_LABEL, SEQ_DELIMETERS, START_TOKEN, KEEP_LABEL, UNK_LABEL, CORRECT_LABEL
...
class Seq2EditDataset(Dataset):
    def __init__(self, data_path, use_cache, tokenizer, vocab, max_num_tokens, tag_strategy, skip_complex=0,
                 skip_correct=0, tp_prob=1, tn_prob=1):
        super().__init__()
    ...
    def read_data(self, path):
        ...
        with open(path, "r", encoding="utf8") as fr:
            for line in tqdm(fr):
                ...
                input_ids, offsets, truncated_seq_length = self.tokenizer.encode(words, add_special_tokens=False,
