...
from gector.dataset import MyCollate, Seq2EditDataset
...
def init_dataloader(subset,
    ...
    log_dist(f"is distributed: {is_distributed}, "
             f"thus we use {'distributed sampler' if is_distributed else 'default sampler'}",
             ranks=[0])
